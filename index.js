...
async function publicarFortnite(
  ...
  try {
    ...
    console.log(
      `🎮 Fortnite: traduzindo "${noticia.titulo}"`
    );
    ...
    console.log(
      `✅ Fortnite publicado em PT-BR: ${tituloPT}`
    );
...
async function cicloNoticias() {
  ...
  try {
    ...
    console.log(
      `📊 FORTNITE TOTAL: ${totalFortnite} notícia(s) nova(s) publicada(s).`
    );
